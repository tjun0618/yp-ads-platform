...
function renderBody(items){
  ...
  body.innerHTML=items.map((p,i)=>{
    ...
    let adBtn='';
    if(p.has_plan){
      adBtn='<button style="background:#2e7d32;color:#fff;padding:4px 12px;border:none;border-radius:6px;font-size:.78rem;font-weight:600;cursor:pointer;" onclick="downloadPlan(''+p.asin+'')">下载方案</button>';
